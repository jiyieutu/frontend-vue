...
const FRIENDLY_MESSAGES = {
  ...
  BACKUP_ACCOUNT_CREATE_FAILED: '存储节点配置创建失败。',
  BACKUP_ACCOUNT_DIR_REQUIRED: '请输入备份源路径。',
  BACKUP_ACCOUNT_DIR_TOO_LONG: '备份源路径长度超出限制。',
  BACKUP_ACCOUNT_DUPLICATE: '已存在相同客户端 IP 的存储节点配置。',
  BACKUP_ACCOUNT_ID_INVALID: '存储节点配置 ID 无效。',
  BACKUP_ACCOUNT_NOT_FOUND: '未找到所选存储节点配置。',
  ...
  BACKUP_ACCOUNT_STATUS_INVALID: '存储节点配置状态无效。',
  ...
  BACKUP_ACCOUNT_TITLE_REQUIRED: '请输入存储节点配置名称。',
  BACKUP_ACCOUNT_TITLE_TOO_LONG: '存储节点配置名称长度超出限制。',
  BACKUP_ACCOUNT_UPLOAD_SCHEDULE_INVALID: '上传时间策略无效。',
  BACKUP_ACCOUNT_USERNAME_REQUIRED: '请输入备份客户端用户名。',
  BACKUP_UPLOAD_FAILED: '备份上传失败。',
  BACKUP_UPLOAD_RUNNING: '当前存储节点配置正在上传，请稍后重试。',
  BACKUP_UPLOAD_TARGET_INVALID: '上传目标配置无效。',
  BACKUP_UPLOAD_UNSUPPORTED_TARGET: '当前备份上传不支持所选存储类型。',
  ...
  ARCHIVE_PACKAGE_EXTRACT_FAILED: '服务端解包归档失败，请检查磁盘空间和目录权限。',
  ARCHIVE_PACKAGE_INVALID: '上传包内容无效，请重新选择文件夹上传。',
  ARCHIVE_PACKAGE_TOO_LARGE: '上传包总大小超过系统限制，请分批上传。',
  ARCHIVE_PACKAGE_TOO_MANY_FILES: '上传包文件数量超过系统限制，请分批上传。',
  ARCHIVE_PACKAGE_UNSAFE_PATH: '上传包内包含不安全路径，已拒绝入账。',
  ARCHIVE_TARGET_DISABLED: '所选归档目标已停用。',
  ARCHIVE_TARGET_INVALID: '所选归档目标不可用，请检查存储设备配置。',
  ARCHIVE_TARGET_REQUIRED: '请选择归档目标存储。',
  ARCHIVE_TARGET_UNSUPPORTED: '归档目标类型不支持。',
  ...
  MANAGED_FS_ACCESS_DENIED: '当前账号没有权限操作该路径。',
  MANAGED_FS_CATALOG_NOT_READY: '受管文件元数据表未初始化。',
  MANAGED_FS_CREATE_DIRECTORY_FAILED: '创建目录失败。',
  MANAGED_FS_DELETE_DISABLED: '当前系统已禁用删除操作。',
  MANAGED_FS_DELETE_FAILED: '删除文件或目录失败。',
  MANAGED_FS_DELETE_ROOT_FORBIDDEN: '不能删除存储中心根目录。',
  MANAGED_FS_DIRECTORY_EXISTS: '目录已存在。',
  MANAGED_FS_DISABLED: '存储中心文件管理未启用。',
  MANAGED_FS_LIST_FAILED: '读取目录失败。',
  MANAGED_FS_NOT_DIRECTORY: '当前路径不是目录。',
  MANAGED_FS_NOT_FILE: '当前路径不是文件。',
  MANAGED_FS_NOT_FOUND: '路径不存在。',
  MANAGED_FS_PATH_INVALID: '路径无效。',
  MANAGED_FS_PATH_OUT_OF_ROOT: '路径不在受管根目录内。',
  MANAGED_FS_ROOT_EMPTY: '受管根目录未配置。',
  MANAGED_FS_ROOT_INVALID: '受管根目录配置无效。',
  MANAGED_FS_ROOT_MISSING: '受管根目录不存在。',
  MANAGED_FS_ARCHIVE_COPY_INVALID: '归档副本记录不完整。',
  MANAGED_FS_ARCHIVE_COPY_MISSING: '归档副本不存在或不可读取。',
  MANAGED_FS_ARCHIVE_COPY_NOT_FOUND: '没有找到可读取的归档副本。',
  MANAGED_FS_ARCHIVE_COPY_OFFLINE: '该归档副本需要离线取盘读取。',
  MANAGED_FS_ARCHIVE_NODE_NOT_FOUND: '未找到该文件的生命周期台账记录。',
  MANAGED_FS_ARCHIVE_STREAM_FAILED: '读取归档副本失败。',
  MANAGED_FS_RULE_ID_INVALID: '生命周期规则 ID 无效。',
  MANAGED_FS_RULE_REQUIRED: '请填写生命周期规则必填项。',
  MANAGED_FS_RULE_TIME_INVALID: '定时分发时间无效，请使用 HH:mm 格式。',
  MANAGED_FS_STAT_FAILED: '读取文件元数据失败。',
  MANAGED_FS_STREAM_FAILED: '读取文件流失败。',
  MANAGED_FS_SYNC_FAILED: '同步目录元数据失败。',
  MANAGED_FS_TARGET_EXISTS: '目标路径已存在。',
  MANAGED_FS_UPLOAD_EMPTY: '请先选择要上传的文件。',
  MANAGED_FS_UPLOAD_NAME_INVALID: '上传文件名无效。',
  MANAGED_FS_UPLOAD_PATH_INVALID: '上传路径无效。',
  MANAGED_FS_UPLOAD_ROOT_CREATE_FAILED: '创建上传目录失败。',
